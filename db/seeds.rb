...
move_1 = Move.create(name: "Saut de chat", level: "Intermediate", description: "Franchissement d'un obstacle en plongeant et en poussant sur les bras afin de faire passer ses jambes entre ses bras.", video: "https://res.cloudinary.com/ddz8gswxn/video/upload/v1669819247/Tracer/saut_de_chat_lr3olz.mp4")
move_2 = Move.create(name: "Double saut de chat", level: "Advanced", description: "Saut de chat avec deux appuis mains sur deux obstacles se suivant.", video: "https://res.cloudinary.com/ddz8gswxn/video/upload/v1669820169/Tracer/Elevator_Music_d3gvc8.mp4")
move_3 = Move.create(name: "Saut de bras", level: "Intermediate", description: "Le saut de bras est un saut dont la réception se fait à la force des bras généralement contre un mur.", video: "https://res.cloudinary.com/ddz8gswxn/video/upload/v1669819272/Tracer/saut_de_bras_qbddw7.mp4")
...
move_5 = Move.create(name: "Saut de précision ou saut de préss", level: "Beginner", description: "Saut pieds joints sans élan, dont la réception se fait sur une petite surface (muret par exemple). On se réceptionne en se stabilisant sur le muret.", video: "https://res.cloudinary.com/ddz8gswxn/video/upload/v1669818870/Tracer/saut_de_precision_dap4pd.mp4")
move_6 = Move.create(name: "Saut de détente", level: "Beginner", description: "Saut réalisé avec élan pour franchir une distance impossible en saut de précision.", video: "https://res.cloudinary.com/ddz8gswxn/video/upload/v1669820169/Tracer/Elevator_Music_d3gvc8.mp4")
move_7 = Move.create(name: "Saut de fond", level: "Intermediate", description: "Saut en contrebas effectué d'une hauteur importante, suivi généralement par une roulade.", video: "https://res.cloudinary.com/ddz8gswxn/video/upload/v1669819296/Tracer/saut_de_fond_hafflj.mp4")
...
move_9 = Move.create(name: "Passement rapide ou saut de voleur", level: "Intermediate", description: "Franchissement d'un obstacle bas avec un seul appui main et en passant la jambe extérieure avant l'intérieure.", video: "https://res.cloudinary.com/ddz8gswxn/video/upload/v1669819330/Tracer/saut_du_voleur_vpnwe6.mp4")
move_10 = Move.create(name: "Saut de paresseux", level: "Advanced", description: "Franchissement d'un obstacle bas avec un seul appui main et en passant la jambe intérieure avant l'extérieure.", video: "https://res.cloudinary.com/ddz8gswxn/video/upload/v1669820169/Tracer/Elevator_Music_d3gvc8.mp4")
move_11 = Move.create(name: "Passe-muraille", level: "Intermediate", description: "Technique de franchissement d'un mur d'une hauteur assez importante ; consiste à prendre appui sur le mur avec un pied pour atteindre une plus grande hauteur.", video: "https://res.cloudinary.com/ddz8gswxn/video/upload/v1669820169/Tracer/Elevator_Music_d3gvc8.mp4")
