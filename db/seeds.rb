...
move_2 = Move.create(name: "Double saut de chat", level: "Avancé", description: "Saut de chat avec deux appuis mains sur deux obstacles se suivant.",pre_requis: "Savoir faire un saut de chat plongé",attention: "Ne pas garder les mains sur le premier obstacle. Vérifier l'état de l'obstacle et du sol (débris, sol glissant...)" ,video: "https://res.cloudinary.com/ddz8gswxn/video/upload/v1669820169/Tracer/Elevator_Music_d3gvc8.mp4")
